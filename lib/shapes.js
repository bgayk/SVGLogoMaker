...
class Shape {
    ...
    renderText() {
        let data = '';
        data += '<style> .logo{font: normal 30px sans-serif;} </style>' + '\n';
        data += `<text x="150" y="100" class="logo" text-anchor="middle" fill="${this.userTextColor}">${this.userText}</text>`;   
        return data; 
    };
    ...
    module.exports = {Shape, Circle, Triangle, Square, generateSVGData};
